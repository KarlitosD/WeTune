      ...
      <>
        <nav class="container flex items-center justify-around p-4 gap-10 text-gray-600">
          ...
          <form class="form-control" action={searchAction} method="post">
            <fieldset class="join" disabled={isRouting()}>
              <input class="input input-bordered sm:w-96 join-item" type="search" name="search" placeholder="Search" value={location?.query?.search || ""} />
